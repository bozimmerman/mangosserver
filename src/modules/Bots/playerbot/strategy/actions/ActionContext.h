...
namespace ai
{
    ...
    public:
        ActionContext()
        {
            ...
            creators["attack threat target"] = &ActionContext::attack_threat_target;
    ...
    private:
        ...
        static Action* attack_threat_target(PlayerbotAI* ai) { return new AttackThreatTargetAction(ai); }
