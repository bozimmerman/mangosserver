...
cmake . -DPLAYERBOTS=1 -DBUILD_REALMD=0 -DBUILD_TOOLS=0 -DBUILD_AH_SERVICE=0 -DCMAKE_INSTALL_PREFIX=/opt/mangos -DCMAKE_INSTALL_SYSCONFDIR=/opt/mangos/etc  -DCMAKE_CXX_FLAGS="-w"
make -j8
